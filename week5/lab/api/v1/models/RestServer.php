...
class RestServer {
    ...
    //function to set message for the api
    public function setMessage($message) {
        $this->response["message"] = $message;
    }
    //fucntion to set the message for an error response
    public function setErrors($errors) {
        $this->response["errors"] = $errors;
    }
    
    //fucntion to set the data to be displayed in the api
    public function setData($data) {
        $this->response["data"] = $data;
    }
    
    //function to display the status based on if you deleted updated or posted
